...
wapi_result_t wapi_dialog_open_file(const wapi_dialog_filter_t* filters,
                                    ...
                                    wapi_string_view_t default_path,
                                    wapi_flags_t flags,
...
wapi_result_t wapi_dialog_open_folder(wapi_string_view_t default_path,
                                      char* buf, wapi_size_t buf_len,
                                      wapi_size_t* result_len);
...
wapi_result_t wapi_dialog_simple_message_box(wapi_string_view_t title,
                                             wapi_string_view_t message);
